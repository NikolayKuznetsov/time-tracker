var TablePaginationCtrl = function () {
    ...
    tt.setItemsPerPage = function(num) {
        tt.itemsPerPage = num;
        tt.currentPage = 1; //reset to first paghe
    }
};

TablePaginationCtrl.$inject = [];
angular.module('app').controller('TablePaginationCtrl', TablePaginationCtrl);